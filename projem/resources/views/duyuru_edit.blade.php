...
<div class="collapse navbar-collapse" id="navbarNavDropdown">
  ...
  <div class="content-wrapper">
    ...
    <form action="{{ route('duyurular.update', $duyuru->id) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="form-group">
            <label for="baslik">Başlik</label>
            <input type="text" name="baslik" id="baslik" class="form-control" value="{{ $duyuru->baslik }}" required>
        </div>

        <div class="form-group">
            <label for="icerik">İçerik</label>
            <textarea name="icerik" id="icerik" class="form-control" required>{{ $duyuru->icerik }}</textarea>
        </div>
